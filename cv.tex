...
{\begin{itemize}
	...
	\item Bardzo dobra znajomość \textbf{Microsoft Excel} (w tym \textbf{Excel VBA} oraz zastosowanie arkusza kalkulacyjnego w zagadnieniach symulacyjnych),
    \item Bardzo dobra znajomość \textbf{Microsoft Access} (w tym tworzenie baz danych, \textbf{Access VBA}, \textbf{Access SQL}),
	\item Programowanie w języku \textbf{SQL},
...
\section{Certyfikaty}
{\begin{itemize}
	\item \textbf{SPSS Technology Expert} – potwierdzenie znajomości metod ilościowych z wykorzystaniem pakietu SPSS,
    \item \textbf{Cambridge Certificate in Advanced English}{,}
	\item \textbf{TestDaF} (Deutsch als Fremdsprache).
\end{itemize}}
...
\item rysunek odręczny,
\item praca z drewnem.
